...
import bio.terra.blah.client.ApiClient;
...
public class BlahClient extends ApiClient {
   ...
   */
  public BlahClient(ServerSpecification server) throws IOException {
    this(server, null);
  }
   ...
   */
  public BlahClient(ServerSpecification server, TestUserSpecification testUser)
      throws IOException {
